...
class CurrentTimelineTextPlusInput:
    ...
    def ask_for_input(cls):
        ...
        while True:
            track_index = terminal_io.prompt(f"Please enter a video track index (available track: 1 to {track_count})\n"
...
class VideoTrackIndicesInput:
    ...
    def ask_for_input(cls):
        ...
        while True:
            track_indices = terminal_io.prompt(f"Please enter video track indices (available track: 1 to {track_count})\n"
